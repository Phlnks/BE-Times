...
const TimePicker: React.FC<Props> = ({ value, onChange, accentColor }) => {
  ...
  return (
    <div className="p-4 bg-white border border-slate-200 rounded-2xl shadow-2xl w-full animate-in fade-in zoom-in-95 duration-200">
      <div className="mb-4">
      ...
      <div className="mt-4 pt-3 border-t border-slate-100 flex justify-between items-center">
        <span className="text-xs font-bold text-slate-400">Heure choisie:</span>
